...
// context
import { useUserDispatch, registerUser, loginUser, Authentication } from "../../context/UserContext";
...
function Login(props) {
  ...
  var [userseqno, setUserseqno] = useState("");
  ...
  useEffect(()=>{
    ...
    if (authCode!=null){
      getToken(authCode, setAccesstoken, setRefreshtoken, setUserseqno)
      setActiveTabId(1)
          ...
          {activeTabId === 1 && (
            <React.Fragment>
              ...
              <TextField
                ...
                value={userseqno}
                onChange={e => setUserseqno(e.target.value)}
                margin="normal"
